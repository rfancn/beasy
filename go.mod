module github.com/rfancn/beasy
...
require (
	...
	github.com/hdget/common v0.1.17 // indirect
	github.com/hdget/provider-config-viper v0.1.2 // indirect
	github.com/hdget/provider-logger-zerolog v0.1.1 // indirect
