 ...
 */
gchar *oul_ntlm_gen_type1(const gchar *hostname, const gchar *domain);
 ...
 */
guint8 *oul_ntlm_parse_type2(const gchar *type2, guint32 *flags);
 ...
 * @param nonce The nonce returned by oul_ntlm_parse_type2
 * @param flags Pointer to the flags returned by oul_ntlm_parse_type2
 * @return A base64 encoded type3 message.  This should be g_free'd by
 *         the caller.
 */
gchar *oul_ntlm_gen_type3(const gchar *username, const gchar *passw, const gchar *hostname, const gchar *domain, const guint8 *nonce, guint32 *flags);
